...
saveRDS(compl_df, "analysis/data-derived/complete_times_higher_res.rds")
...
write.csv(central_df, here::here("analysis/data-out/central_times_higher_res.csv"), row.names = FALSE)
write.csv(worst_df, here::here("analysis/data-out/pessimistic_times_higher_res.csv"), row.names = FALSE)
write.csv(best_df, here::here("analysis/data-out/optimistic_times_higher_res.csv"), row.names = FALSE)
...
# And save to file
write.csv(md_central_out, here::here("analysis/data-out/central_longitudinal_times_higher_res.csv"), row.names = FALSE)
write.csv(md_worst_out, here::here("analysis/data-out/pessimistic_longitudinal_times_higher_res.csv"), row.names = FALSE)
write.csv(md_best_out, here::here("analysis/data-out/optimistic_longitudinal_times_higher_res.csv"), row.names = FALSE)
