...
scenario_maps <- readRDS(here::here("analysis/data-derived/scenario_maps_higher_res_full.rds"))
...
save_figs("spread_africa_higher_res", spread_gg, width = 25, height = 8, pdf_plot = FALSE, font_family = "Helvetica")
...
dir.create("analysis/plots/time_series_higher_res")
out_plots <- furrr::future_map(seq_along(unique(out$t)), function(i) {
  ...
  arms:::save_figs(paste0("test_",sprintf("%03d",i)), fig = gg_x,
                    width = 12, height = 12, pdf_plot = FALSE, plot_dir = "analysis/plots/time_series_higher_res/",
...
mapmate::ffmpeg(dir = "analysis/plots/time_series_higher_res/",
                output_dir = "analysis/plots/time_series_higher_res/",
                pattern = "test_%03d.png", output = "test_video_higher_res.mp4",
...
saveRDS(compl_df, "analysis/data-derived/complete_prospective_times_higher_res.rds")
...
write.csv(central_df, "analysis/data-out/central_times_prospective_higher_res.csv", row.names = FALSE)
write.csv(worst_df, "analysis/data-out/pessimistic_times_prospective_higher_res.csv", row.names = FALSE)
write.csv(best_df, "analysis/data-out/optimistic_times_prospective_higher_res.csv", row.names = FALSE)
