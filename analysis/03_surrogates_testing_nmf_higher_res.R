...
res_list <- readRDS(here::here("analysis/data-derived/modelnmf_higher_res_s.rds"))
...
saveRDS(list(a1_xgb,a2_xgb,a3_xgb,a4_xgb,a5_xgb,a6_xgb), "analysis/data-derived/xgb_nmf_higher_res_list.rds")
...
a1_brnn <- train_brnn("s_a_1", train = train, neurons = 2)
a2_brnn <- train_brnn("s_a_2", train = train, neurons = 2)
a3_brnn <- train_brnn("s_a_3", train = train, neurons = 2)
a4_brnn <- train_brnn("s_a_4", train = train, neurons = 2)
a5_brnn <- train_brnn("s_a_5", train = train, neurons = 2)
a6_brnn <- train_brnn("s_a_6", train = train, neurons = 2)
saveRDS(list(a1_brnn,a2_brnn,a3_brnn,a4_brnn,a5_brnn,a6_brnn), "analysis/data-derived/brnn_nmf_higher_res_list.rds")
...
xgb_mod_list <- readRDS("analysis/data-derived/xgb_nmf_higher_res_list.rds")
brnn_mod_list <- readRDS("analysis/data-derived/brnn_nmf_higher_res_list.rds")
monmlp_mod_list <- readRDS("analysis/data-derived/monmlp_nmf_higher_res_list.rds")
...
saveRDS(res_mod, "analysis/data-derived/res_nmf_higher_res_mod.rds")
...
res_mod <- readRDS(here::here("analysis/data-derived/res_nmf_higher_res_mod.rds"))
...
saveRDS(list(a1_xgb_err, a2_xgb_err, a3_xgb_err, a4_xgb_err, a5_xgb_err, a6_xgb_err),
        "analysis/data-derived/xgb_nmf_higher_res_err_list.rds")
...
saveRDS(list(a1_brnn_err, a2_brnn_err, a3_brnn_err, a4_brnn_err, a5_brnn_err, a6_brnn_err),
        "analysis/data-derived/brnn_nmf_higher_res_err_list.rds")
...
saveRDS(list(a1_monmlp_err[[1]], a2_monmlp_err[[1]], a3_monmlp_err[[1]],
        ...
        "analysis/data-derived/monmlp_nmf_higher_res_err_list.rds")

# create our model lists
xgb_err_mod_list <- readRDS("analysis/data-derived/xgb_nmf_higher_res_err_list.rds")
brnn_err_mod_list <- readRDS("analysis/data-derived/brnn_nmf_higher_res_err_list.rds")
monmlp_err_mod_list <- readRDS("analysis/data-derived/monmlp_nmf_higher_res_err_list.rds")
...
# create our test data set here for errors if needed
...
saveRDS(new_res, here::here("analysis/data-derived/res_nmf_higher_res_mod.rds"))
