...
train_monmlp <- function(s = "s_a_5", h2 = 3:6, h1 = 4:10, train = train){
...
a1_xgb_err <- train_xgboost_err("s_a_1", train = train_reps, eta = 0.2)
a2_xgb_err <- train_xgboost_err("s_a_2", train = train_reps, eta = 0.2)
a3_xgb_err <- train_xgboost_err("s_a_3", train = train_reps, eta = 0.2)
a4_xgb_err <- train_xgboost_err("s_a_4", train = train_reps, eta = 0.2)
a5_xgb_err <- train_xgboost_err("s_a_5", train = train_reps, eta = 0.2)
a6_xgb_err <- train_xgboost_err("s_a_6", train = train_reps, eta = 0.2)
saveRDS(list(a1_xgb_err, a2_xgb_err, a3_xgb_err, a4_xgb_err, a5_xgb_err, a6_xgb_err),
        "analysis/data-derived/xgb_err_list.rds")
...
saveRDS(list(a1_brnn_err, a2_brnn_err, a3_brnn_err, a4_brnn_err, a5_brnn_err, a6_brnn_err),
        "analysis/data-derived/brnn_err_list.rds")

# train monmlp err models
train_monmlp_err <- function(s = "s_a_5", h2 = 3:6, h1 = 4:10, train = train){
...
saveRDS(list(a1_monmlp_err[[1]], a2_monmlp_err[[1]], a3_monmlp_err[[1]],
        ...
        "analysis/data-derived/monmlp_err_list.rds")

# create our model lists
xgb_err_mod_list <- readRDS("analysis/data-derived/xgb_err_list.rds")
brnn_err_mod_list <- readRDS("analysis/data-derived/brnn_err_list.rds")
monmlp_err_mod_list <- readRDS("analysis/data-derived/monmlp_err_list.rds")
