...
# get file dir
res_dir <- here::here("analysis/data-derived/sims_nmf_higher_res/")
...
res_list <- foreach(
  i = sort(as.integer(gsub("rnmf_(\\d*)\\.rds", "\\1", list.files(here::here("analysis/data-derived/sims_nmf_higher_res/"))))),
...
saveRDS(res_list, here::here("analysis/data-derived/modelnmf_higher_res_s.rds"))
