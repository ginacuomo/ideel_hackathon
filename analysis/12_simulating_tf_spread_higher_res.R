...
write.csv(md_central_out, "analysis/data-out/central_longitudinal_times_prospective_higher_res.csv", row.names = FALSE)
write.csv(md_worst_out, "analysis/data-out/pessimistic_longitudinal_times_prospective_higher_res.csv", row.names = FALSE)
write.csv(md_best_out, "analysis/data-out/optimistic_longitudinal_times_prospective_higher_res.csv", row.names = FALSE)
